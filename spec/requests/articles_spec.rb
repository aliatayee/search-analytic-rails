...
RSpec.describe "Articles", type: :request do
  ...
  articles = Article.create(title: "This is an article title", content:"This is the article content for test")
  articles = Article.create(title: "What is the best way to learn ruby", content:"Learning to code is easier than you may think (even if you’re brand new). Start Today! Choose from in-demand programming languages and courses based on your unique goals.")
